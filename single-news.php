...
$reply = new Reply($db);
// set ID property of news to be read
$news->id = $id;
$user->id = $user_id;
// read the details of news to be read
$news->readOne();
$user->readOne();
// set page title
$page_title = "News";
		  ...
		  <div class="col-12 col-lg-8">
		    <div class="blog-posts-area">
		      ...
		      <div class="single-blog-post featured-post single-post">
		        ...
		        <div class="post-data">
		          <a href="#" class="post-catagory"><?php echo $news->source; ?></a>
		          <a href="#" class="post-title">
		            <h6><?php echo $news->title; ?></h6>
		          </a>
		          <div class="post-meta">
		            <p class="post-author">By <a href="#"><?php echo $news->author; ?></a></p>
