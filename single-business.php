		    ...
		    <div class="blog-posts-area">
		      ...
		      <div class="single-blog-post featured-post single-post">
		        <div class="post-thumb">
		          <a href="#">
		          	<img src="<?php echo $business->image; ?>" alt="">
		          </a>
		        </div>
		        <div class="post-data">
		          <a href="#" class="post-catagory"><?php echo $business->source; ?></a>
		          <a href="#" class="post-title">
		            <h6><?php echo $business->title; ?></h6>
		          </a>
		          <div class="post-meta">
		            <p class="post-author">By <a href="#"><?php echo $business->author; ?></a></p>
		            ...
		            <p><?php echo $business->content; ?></p>
		            <div class="businesspaper-post-like d-flex align-items-center justify-content-between">
		              <!-- Tags -->
		              <div class="businesspaper-tags d-flex">
		                <span>Tags:</span>
		                <ul class="d-flex">
            ...
            <div class="contact-form-area">
            	<form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                  ...
                  <div class="col-12 text-center">
                    <button class="btn businesspaper-btn mt-30 w-100" type="submit">Submit Comment</button>
                  </div>
                </div>
              </form>
          	</div>
        	</div>
	        <!-- ##### Popular business Area Start ##### -->
		        ...
		        if ($recaptcha->score >= 0.5) {
					...
					<div class="popular-business-area">
					  <div class="container">
					    <div class="row">
					      <div class="col-12 col-lg-5">
					        <!-- businessletter Widget -->
