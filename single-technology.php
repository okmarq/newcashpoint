...
// get ID of the technology to be read
...
$reply = new Reply($db);
// set ID property of technology to be read
$technology->id = $id;
$user->id = $user_id;
// read the details of technology to be read
$technology->readOne();
$user->readOne();
// set page title
		    ...
		    <div class="blog-posts-area">
		      ...
		      <div class="single-blog-post featured-post single-post">
		        <div class="post-thumb">
		          <a href="#">
		          	<img src="<?php echo $technology->image; ?>" alt="">
		          </a>
		        </div>
		        <div class="post-data">
		          <a href="#" class="post-catagory"><?php echo $technology->source; ?></a>
		          <a href="#" class="post-title">
		            <h6><?php echo $technology->title; ?></h6>
		          </a>
		          <div class="post-meta">
		            <p class="post-author">By <a href="#"><?php echo $technology->author; ?></a></p>
		            ...
		            <div class="technologypaper-post-like d-flex align-items-center justify-content-between">
		              <!-- Tags -->
		              <div class="technologypaper-tags d-flex">
		                <span>Tags:</span>
		                <ul class="d-flex">
            ...
            <div class="contact-form-area">
            	<form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                  ...
                  <div class="col-12 text-center">
                    <button class="btn technologypaper-btn mt-30 w-100" type="submit">Submit Comment</button>
                  </div>
                </div>
              </form>
          	</div>
        	</div>
	        <!-- ##### Popular technology Area Start ##### -->
		        ...
		        if ($recaptcha->score >= 0.5) {
					...
					<div class="popular-technology-area">
					  <div class="container">
					    <div class="row">
					      <div class="col-12 col-lg-5">
					        <!-- technologyletter Widget -->
					        <div class="technologyletter-widget">
