...
class TechnologyNews{
  ...
  private $conn;
  private $table_name = "technology_news";
  // object properties
  public $id;
  public $source;
	public $title;
  ...
  public function __construct($db){
	...
	function putNews(){
		$technology_url="http://newsapi.org/v2/top-headlines?country=ng&category=technology&apiKey=9eb2de497dba47d09843655d6811698a";
		$ch = curl_init();
		$options = [
		...
		for ($i=0; $i < 20; $i++) {
			...
			$sth = $this->conn->prepare("INSERT INTO technology_news ( " . implode(', ',array_keys($news)) . ") VALUES (" . implode(', ',array_keys($prep)) . ")");
