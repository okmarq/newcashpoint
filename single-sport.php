...
// get ID of the sport to be read
...
$reply = new Reply($db);
// set ID property of sport to be read
$sport->id = $id;
$user->id = $user_id;
// read the details of sport to be read
$sport->readOne();
$user->readOne();
// set page title
$page_title = "Sport";
		    ...
		    <div class="blog-posts-area">
		      ...
		      <div class="single-blog-post featured-post single-post">
		        <div class="post-thumb">
		          <a href="#">
		          	<img src="<?php echo $sport->image; ?>" alt="">
		          </a>
		        </div>
		        <div class="post-data">
		          <a href="#" class="post-catagory"><?php echo $sport->source; ?></a>
		          <a href="#" class="post-title">
		            <h6><?php echo $sport->title; ?></h6>
		          </a>
		          <div class="post-meta">
		            <p class="post-author">By <a href="#"><?php echo $sport->author; ?></a></p>
		            <p><?php echo $sport->description; ?></p>
		            <a href="#" class="related--post">Related: Facebook announces changes to combat election meddling</a>
		            <p><?php echo $sport->content; ?></p>
		            <div class="sportpaper-post-like d-flex align-items-center justify-content-between">
		              <!-- Tags -->
		              <div class="sportpaper-tags d-flex">
		                <span>Tags:</span>
		                <ul class="d-flex">
            ...
            <div class="contact-form-area">
            	<form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                  ...
                  <div class="col-12 text-center">
                    <button class="btn sportpaper-btn mt-30 w-100" type="submit">Submit Comment</button>
                  </div>
                </div>
              </form>
          	</div>
        	</div>
	        <!-- ##### Popular sport Area Start ##### -->
		        ...
		        if ($recaptcha->score >= 0.5) {
					...
					<div class="popular-sport-area">
					  <div class="container">
					    <div class="row">
					      <div class="col-12 col-lg-5">
					        <!-- sportletter Widget -->
					        <div class="sportletter-widget">
