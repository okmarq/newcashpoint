...
// get ID of the science to be read
...
$reply = new Reply($db);
// set ID property of science to be read
$science->id = $id;
$user->id = $user_id;
// read the details of science to be read
$science->readOne();
$user->readOne();
// set page title
$page_title = "Science";
		    ...
		    <div class="blog-posts-area">
		      ...
		      <div class="single-blog-post featured-post single-post">
		        <div class="post-thumb">
		          <a href="#">
		          	<img src="<?php echo $science->image; ?>" alt="">
		          </a>
		        </div>
		        <div class="post-data">
		          <a href="#" class="post-catagory"><?php echo $science->source; ?></a>
		          <a href="#" class="post-title">
		            <h6><?php echo $science->title; ?></h6>
		          </a>
		          <div class="post-meta">
		            <p class="post-author">By <a href="#"><?php echo $science->author; ?></a></p>
		            <p><?php echo $science->description; ?></p>
		            <a href="#" class="related--post">Related: Facebook announces changes to combat election meddling</a>
		            <p><?php echo $science->content; ?></p>
		            <div class="sciencepaper-post-like d-flex align-items-center justify-content-between">
		              <!-- Tags -->
		              <div class="sciencepaper-tags d-flex">
		                <span>Tags:</span>
		                <ul class="d-flex">
            ...
            <div class="contact-form-area">
            	<form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                  ...
                  <div class="col-12 text-center">
                    <button class="btn sciencepaper-btn mt-30 w-100" type="submit">Submit Comment</button>
                  </div>
                </div>
              </form>
          	</div>
        	</div>
	        <!-- ##### Popular science Area Start ##### -->
		        ...
		        if ($recaptcha->score >= 0.5) {
					...
					<div class="popular-science-area">
					  <div class="container">
					    <div class="row">
					      <div class="col-12 col-lg-5">
					        <!-- scienceletter Widget -->
					        <div class="scienceletter-widget">
