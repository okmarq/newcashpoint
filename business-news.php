...
?>
	...
	<div class="featured-post-area section-padding-25-10">
	  <div class="container">
      <!-- Business News -->
	    ...
	    <div class="row">
            ...
            <div class="single-blog-post small-featured-post d-flex">
              <div class="post-thumb">
                <a href="#"><img src="<?php echo $image; ?>" alt="" width=""></a>
              </div>
              <div class="post-data">
                <a href="#" class="post-catagory"><?php echo $source; ?></a>
	              <div class="post-meta">
	              	<a href='single-business?news-id=<?php echo $id ?>' class="post-title">
