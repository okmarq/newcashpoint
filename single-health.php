...
// get ID of the health to be read
...
$reply = new Reply($db);
// set ID property of health to be read
$health->id = $id;
$user->id = $user_id;
// read the details of health to be read
$health->readOne();
$user->readOne();
// set page title
$page_title = "Health";
		    ...
		    <div class="blog-posts-area">
		      ...
		      <div class="single-blog-post featured-post single-post">
		        <div class="post-thumb">
		          <a href="#">
		          	<img src="<?php echo $health->image; ?>" alt="">
		          </a>
		        </div>
		        <div class="post-data">
		          <a href="#" class="post-catagory"><?php echo $health->source; ?></a>
		          <a href="#" class="post-title">
		            <h6><?php echo $health->title; ?></h6>
		          </a>
		          <div class="post-meta">
		            <p class="post-author">By <a href="#"><?php echo $health->author; ?></a></p>
		            ...
		            <p><?php echo $health->content; ?></p>
		            <div class="healthpaper-post-like d-flex align-items-center justify-content-between">
		              <!-- Tags -->
		              <div class="healthpaper-tags d-flex">
		                <span>Tags:</span>
		                <ul class="d-flex">
            ...
            <div class="contact-form-area">
            	<form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                  ...
                  <div class="col-12 text-center">
                    <button class="btn healthpaper-btn mt-30 w-100" type="submit">Submit Comment</button>
                  </div>
                </div>
              </form>
          	</div>
        	</div>
	        <!-- ##### Popular health Area Start ##### -->
		        ...
		        if ($recaptcha->score >= 0.5) {
					...
					<div class="popular-health-area">
					  <div class="container">
					    <div class="row">
					      <div class="col-12 col-lg-5">
					        <!-- healthletter Widget -->
					        <div class="healthletter-widget">
